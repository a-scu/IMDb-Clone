...
const Result = ({ result, genre, index }) => {
  return (
    <Link
      ...
      key={result.id}
      className="cursor-pointer rounded-[.2rem] overflow-hidden transition-colors duration-300 hover:bg-dark_hover ease bg-dark_gray group min-h-[225px] h-full flex flex-col w-full"
    >
      <Image
        width={500}
        height={300}
